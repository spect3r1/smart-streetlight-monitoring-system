...
static const char *WIFI_SSID = "adoola_EXT";
static const char *WIFI_PASSWORD = "8262b5af";
...
void publishTelemetry() {
  ...
  int led1Working = digitalRead(LED1_WORKING_PIN) == HIGH ? 1 : 0;
  int led2Working = digitalRead(LED2_WORKING_PIN) == HIGH ? 1 : 0;
  int led3Working = digitalRead(LED3_WORKING_PIN) == HIGH ? 1 : 0;
  ...
  Serial.print("[TELEMETRY] LED1 working pin GPIO");
  Serial.print(LED1_WORKING_PIN);
  Serial.print(" = ");
  Serial.println(led1Working);

  Serial.print("[TELEMETRY] LED2 working pin GPIO");
  Serial.print(LED2_WORKING_PIN);
  Serial.print(" = ");
  Serial.println(led2Working);

  Serial.print("[TELEMETRY] LED3 working pin GPIO");
...
void setupPins() {
  ...
  Serial.print("[PINS] LED1 working input pin: GPIO");
  Serial.println(LED1_WORKING_PIN);

  Serial.print("[PINS] LED2 working input pin: GPIO");
  Serial.println(LED2_WORKING_PIN);

  Serial.print("[PINS] LED3 working input pin: GPIO");
  ...
  Serial.println("[PINS] LED working pins configured as INPUT_PULLDOWN");
#endif
...
#if DEBUG_ENABLED
  Serial.println("[ADC] ADC attenuation set to ADC_11db for LDR pins");
